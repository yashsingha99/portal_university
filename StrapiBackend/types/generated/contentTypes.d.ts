...
export interface ApiAdmissionPanelAdmissionPanel extends Schema.CollectionType {
  collectionName: 'admission_panels';
  info: {
    singularName: 'admission-panel';
    pluralName: 'admission-panels';
    displayName: 'Admission Panel';
    description: '';
  };
  options: {
...
export interface ApiBranchBranch extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    code: Attribute.String;
    admission_panels: Attribute.Relation<
      'api::branch.branch',
      'oneToMany',
      'api::admission-panel.admission-panel'
    >;
...
export interface ApiTeacherTeacher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sections: Attribute.Relation<
      ...
      'api::section.section'
    >;
    student_time_tables: Attribute.Relation<
      'api::teacher.teacher',
      'oneToMany',
      'api::timetable.timetable'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::admission-panel.admission-panel': ApiAdmissionPanelAdmissionPanel;
