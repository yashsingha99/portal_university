...
const dependencies = {
  ...
  "@strapi/icons": "1.16.0",
  "@strapi/provider-upload-local": "4.22.0",
  "@strapi/utils": "4.22.0",
  axios: "1.6.0",
  "byte-size": "7.0.1",
  cropperjs: "1.6.0",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-eAjEXbAj.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-XjGrpCFX.js"));
        return component;
      },
...
//# sourceMappingURL=index-fR51Mzd6.js.map
