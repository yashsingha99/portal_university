...
export declare const getRelationValidator: (attribute: Attribute.Relation, allowedRelations: ReadonlyArray<string>) => import("yup/lib/object").OptionalObjectSchema<{
