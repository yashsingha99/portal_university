...
const zhHans = {
  ...
  "contentType.draftAndPublish.description": "允许编写条目的草稿版本，在发布之前进行修改",
  "contentType.draftAndPublish.label": "草稿 & 发布",
...
//# sourceMappingURL=zh-Hans-H7FTqsRJ.mjs.map
