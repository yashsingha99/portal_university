const configurations = "Configurações";
const from = "de";
const ptBR = {
  ...
  "contentType.draftAndPublish.description": "Escreva uma versão de rascunho de cada entrada antes de publicá-la",
  "contentType.draftAndPublish.label": "Sistema de rascunho/publicação",
...
//# sourceMappingURL=pt-BR-0wPXJgdL.mjs.map
