...
const th = {
  ...
  "content-manager.components.EmptyAttributesBlock.button": "ไปที่หน้าค่าติดตั้ง",
  "content-manager.components.EmptyAttributesBlock.description": "คุณสามารถเปลี่ยนค่าติดตั้งของคุณ",
  "content-manager.components.FieldItem.linkToComponentLayout": "ตั้งค่าโครงร่างของคอมโพเนนต์",
  "content-manager.components.FilterOptions.button.apply": "นำไปใช้",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "นำไปใช้",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "ล้างข้อมูลทั้งหมด",
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "ตั้งค่าเงื่อนไขเพื่อใช้เพื่อกรองรายการต่างๆ",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter": "ตัวกรอง",
  "content-manager.components.FiltersPickWrapper.hide": "ซ่อน",
  "content-manager.components.LimitSelect.itemsPerPage": "ไอเท็มต่อเพจ",
  "content-manager.components.NotAllowedInput.text": "ไม่มีสิทธิในการดูฟิลด์นี้",
  "content-manager.components.Search.placeholder": "ค้นหารายการ...",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "กำหนดวิธีที่มุมมองแก้ไขจะมีลักษณะเหมือน",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "กำหนดค่าติดตั้งของมุมมองรายการ",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "กำหนดคอนฟิกมุมมอง - {name}",
  ...
  "content-manager.components.TableEmpty.withFilters": "ไม่มี {contentType} ตามตัวกรองที่ใช้ ...",
  "content-manager.components.TableEmpty.withSearch": "ไม่มี {contentType} ที่สอดคล้องกับการค้นหา ({search})...",
  "content-manager.components.TableEmpty.withoutFilter": "ไม่มี {contentType}...",
  "content-manager.components.empty-repeatable": "ยังไม่มีข้อมูล คลิกที่ปุ่มด้านล่างเพื่อเพิ่มข้อมูลเข้าไป",
  "content-manager.components.notification.info.maximum-requirement": "คุณได้มาถึงจำนวนสูงสุดของฟิลด์แล้ว",
  "content-manager.components.notification.info.minimum-requirement": "ฟิลด์ถูกเพิ่มให้ตรงกับข้อกำหนดต่ำสุด",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field": "แก้ไขฟิลด์",
  "content-manager.containers.EditView.notification.errors": "ฟอร์มมีข้อผิดพลาดบางอย่าง",
  "content-manager.containers.Home.introduction": "หากต้องการแก้ไขรายการของคุณให้ไปยังลิงก์ที่ระบุเฉพาะในเมนูด้านซ้าย ปลั๊กอินนี้ไม่มีวิธีที่เหมาะสมในการแก้ไขการตั้งค่าและยังคงอยู่ภายใต้การพัฒนา",
  "content-manager.containers.Home.pluginHeaderDescription": "จัดการรายการของคุณโดยใช้อินเตอร์เฟสที่ทรงพลังและสวยงาม",
  ...
  "content-manager.containers.ListSettingsView.modal-form.edit-label": "แก้ไขเลเบล",
  ...
  "content-manager.containers.SettingPage.attributes.description": "กำหนดลำดับของแอ็ตทริบิวต์",
  "content-manager.containers.SettingPage.editSettings.description": "ลาก & ปล่อยฟิลด์เพื่อสร้างโครงร่าง",
  "content-manager.containers.SettingPage.editSettings.entry.title": "ชื่อรายการ",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "ตั้งค่าฟิลด์ที่แสดงของรายการของคุณ",
  "content-manager.containers.SettingPage.editSettings.title": "มุมมองแก้ไข (ค่าติดตั้ง)",
  "content-manager.containers.SettingPage.layout": "โครงร่าง",
  "content-manager.containers.SettingPage.listSettings.description": "กำหนดคอนฟิกอ็อพชันสำหรับชนิดคอลเล็กชันนี้",
  "content-manager.containers.SettingPage.listSettings.title": "มุมมองรายการ (การตั้งค่า)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "กำหนดคอนฟิกค่าติดตั้งเฉพาะสำหรับชนิดคอลเล็กชันนี้",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description": "กำหนดค่าค่าติดตั้งเฉพาะ",
  "content-manager.containers.SettingsPage.Block.contentType.title": "ชนิดของคอลเล็กชัน",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "กำหนดคอนฟิกค่าพื้นฐานสำหรับชนิดคอลเล็กชันของคุณ",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "ทั่วไป",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "กำหนดคอนฟิกค่าติดตั้งสำหรับชนิดและกลุ่มคอลเล็กชันของคุณทั้งหมด",
  "content-manager.containers.SettingsView.list.subtitle": "กำหนดคอนฟิกโครงร่างและการแสดงชนิดคอลเล็กชันและกลุ่มของคุณ",
  ...
  "content-manager.emptyAttributes.description": "เพิ่มฟิลด์แรกของคุณลงในชนิดคอลเล็กชันของคุณ",
  ...
  "content-manager.error.record.delete": "มีข้อผิดพลาดเกิดขึ้นระหว่างการลบเร็กคอร์ด",
  "content-manager.error.record.fetch": "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลเร็กคอร์ด",
  "content-manager.error.record.update": "มีข้อผิดพลาดเกิดขึ้นระหว่างการอัพเดตเร็กคอร์ด",
  "content-manager.error.records.count": "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลจำนวนนับเร็กคอร์ด",
  "content-manager.error.records.fetch": "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลเร็กคอร์ด",
  "content-manager.error.schema.generation": "มีข้อผิดพลาดเกิดขึ้นระหว่างการสร้างสกีมา",
  ...
  "content-manager.form.Input.label.inputDescription": "ค่านี้แทนที่เลเบลที่แสดงในส่วนหัวของตาราง",
  "content-manager.form.Input.pageEntries": "รายการต่อหน้า",
  "content-manager.form.Input.pageEntries.inputDescription": "หมายเหตุ: คุณสามารถแทนที่ค่านี้ในหน้าค่าติดตั้งชนิดคอลเล็กชัน",
  ...
  "content-manager.notification.error.displayedFields": "คุณต้องการฟิลด์ที่แสดงอย่างน้อยหนึ่งฟิลด์",
  "content-manager.notification.error.relationship.fetch": "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลความสัมพันธ์",
  "content-manager.notification.info.SettingPage.disableSort": "คุณต้องมีหนึ่งแอ็ตทริบิวต์ที่มีการเรียงลำดับที่อนุญาต",
  "content-manager.notification.info.minimumFields": "คุณต้องมีการแสดงฟิลด์อย่างน้อยหนึ่งฟิลด์",
  "content-manager.notification.upload.error": "มีข้อผิดพลาดเกิดขึ้นขณะอัพโหลดไฟล์ของคุณ",
  "content-manager.pageNotFound": "ไม่พบหน้า",
  "content-manager.permissions.not-allowed.create": "คุณไม่ได้รับอนุญาตให้สร้างเอกสาร",
  "content-manager.permissions.not-allowed.update": "คุณไม่ได้รับอนุญาตให้ดูเอกสารนี้",
  "content-manager.plugin.description.long": "วิธีที่รวดเร็วในการดูแก้ไขและลบข้อมูลในฐานข้อมูลของคุณ",
  "content-manager.plugin.description.short": "วิธีที่รวดเร็วในการดูแก้ไขและลบข้อมูลในฐานข้อมูลของคุณ",
  "content-manager.popUpWarning.bodyMessage.contentType.delete": "คุณแน่ใจว่าต้องการลบรายการนี้หรือไม่?",
  "content-manager.popUpWarning.bodyMessage.contentType.delete.all": "คุณแน่ใจว่าคุณต้องการลบรายการเหล่านี้หรือไม่?",
  "content-manager.popUpWarning.warning.cancelAllSettings": "คุณแน่ใจว่าต้องการยกเลิกการแก้ไขของคุณหรือไม่?",
  "content-manager.popUpWarning.warning.updateAllSettings": "สิ่งนี้จะปรับเปลี่ยนค่าติดตั้งทั้งหมดของคุณ",
