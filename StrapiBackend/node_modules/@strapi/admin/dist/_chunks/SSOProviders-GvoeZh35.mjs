...
const SSOProviders = ({ providers, displayAllProviders }) => {
  ...
  if (displayAllProviders) {
    return /* @__PURE__ */ jsx(Grid, { gap: 4, children: providers.map((provider) => /* @__PURE__ */ jsx(GridItem, { col: 4, children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)) });
  }
  if (providers.length > 2 && !displayAllProviders) {
    return /* @__PURE__ */ jsxs(Grid, { gap: 4, children: [
      providers.slice(0, 2).map((provider) => /* @__PURE__ */ jsx(GridItem, { col: 4, children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }) }, provider.uid)),
      /* @__PURE__ */ jsx(GridItem, { col: 4, children: /* @__PURE__ */ jsx(
        Tooltip,
        {
          label: formatMessage({
            id: "global.see-more"
