...
const zhHans = {
  ...
  "Settings.review-workflows.page.subtitle": "{count, plural, one {# 阶段} other {# 阶段}}",
  "Settings.review-workflows.page.isLoading": "工作流正在加载",
  "Settings.review-workflows.page.delete.confirm.body": "分配给已删除阶段的所有条目将移动到上一阶段。您确定要保存吗?",
  ...
  "content-manager.containers.ListPage.items": "{number, plural, =0 {项目} one {项目} other {项目}}",
