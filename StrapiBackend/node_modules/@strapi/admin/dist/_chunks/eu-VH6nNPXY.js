...
const eu = {
  ...
  "content-manager.components.DynamicZone.error-message": "Osagaiak erroreak ditu",
  "content-manager.components.DynamicZone.missing-components": "Hor {number, plural, =0 {are # missing components} bat {is # missing component} beste {are # missing components}}",
  "content-manager.components.DynamicZone.move-down-label": "Eraman osagaia behera",
  ...
  "content-manager.components.EmptyAttributesBlock.button": "Joan ezarpenen orrira",
  "content-manager.components.EmptyAttributesBlock.description": "Zure ezarpenak alda ditzakezu",
  "content-manager.components.FieldItem.linkToComponentLayout": "Ezarri osagaiaren maketazioa",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "Aplikatu",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Garbitu dena",
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Ezarri sarrerak iragazteko aplikatu beharreko baldintzak",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter": "Iragazkiak",
  ...
  "content-manager.components.LimitSelect.itemsPerPage": "Elementu orrialde bakoitzeko",
  "content-manager.components.NotAllowedInput.text": "Ez dago baimenik eremu hau ikusteko",
  "content-manager.components.RepeatableComponent.error-message": "Osagai edo osagaiaek erroreak dituzte",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Pertsonalizatu nola ikusiko den editorea",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Definitu zerrenda-ikuspegiaren ezarpenak",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "Konfiguratu ikuspegia - {name}",
  "content-manager.components.TableDelete.delete": "Ezabatu dena",
  "content-manager.components.TableDelete.deleteSelected": "Ezabatu hautatutakoa",
  "content-manager.components.TableDelete.label": "{{number, plural, bat {# entry} other {# entries}} hautatuta",
  "content-manager.components.TableEmpty.withFilters": "Ez dago {contentType} aplikatutako iragazkiekin...",
  "content-manager.components.TableEmpty.withSearch": "Ez dago {edukiTipo} bat ere bilaketarekin ({search})...",
  "content-manager.components.TableEmpty.withoutFilter": "Ez dago {contentType}...",
  "content-manager.components.empty-repeatable": "Oraindik ez dago sarrerarik. Egin klik beheko botoian bat gehitzeko",
  "content-manager.components.notification.info.maximum-requirement": "Dagoeneko iritsi zara gehienezko eremu kopurura",
  "content-manager.components.notification.info.minimum-requirement": "Gutxieneko eskakizunarekin bat etortzeko eremu bat gehitu da",
  "content-manager.components.repeatable.reorder.error": "Errore bat gertatu da osagaiaren eremua berrantolatzean. Saiatu berriro",
  ...
  "content-manager.containers.Edit.clickToJump": "Egin klik sarrerara salto egiteko",
  ...
  "content-manager.containers.Edit.information.publishedVersion": "bertsio argitaratua",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field": "Editatu eremua",
  "content-manager.containers.EditView.add.new-entry": "Sarrera bat gehitu",
  "content-manager.containers.EditView.notification.errors": "Formularioak akats batzuk ditu",
  "content-manager.containers.Home.introduction": "Zure sarrerak editatzeko, joan ezkerreko menuko esteka zehatzera. Plugin honek ez du ezarpenak editatzeko modu egokirik eta garapen aktiboan dago oraindik",
  "content-manager.containers.Home.pluginHeaderDescription": "Kudeatu zure sarrerak interfaze indartsu eta eder baten bidez",
  ...
  "content-manager.containers.ListPage.displayedFields": "Bistaratzen diren eremuak",
  "content-manager.containers.ListPage.items": "{{number, plural, =0 {items} bat {item} beste {items}}",
  "content-manager.containers.ListPage.table-headers.publishedAt": "Egoera",
  "content-manager.containers.ListSettingsView.modal-form.edit-label": "Editatu {fieldName}",
  ...
  "content-manager.containers.SettingPage.attributes.description": "Definitu atributuen ordena",
  "content-manager.containers.SettingPage.editSettings.description": "Arrastatu eta jaregin eremuak maketazioa eraikitzeko",
  "content-manager.containers.SettingPage.editSettings.entry.title": "Sarreraren izenburua",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Ezarri zure sarreran bistaratzen den eremua",
  "content-manager.containers.SettingPage.editSettings.relation-field.description": "Ezarri bistaratzen den eremua editatzeko eta zerrendako ikuspegietan",
  "content-manager.containers.SettingPage.editSettings.title": "Editatu ikuspegia (ezarpenak)",
  "content-manager.containers.SettingPage.layout": "Maketazioa",
  "content-manager.containers.SettingPage.listSettings.description": "Konfiguratu bilduma mota honen aukerak",
  "content-manager.containers.SettingPage.listSettings.title": "Zerrenda bistaratzea (doikuntzak)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Konfiguratu bilduma mota honen aukerak",
  "content-manager.containers.SettingPage.settings": "Ezarpenak",
  "content-manager.containers.SettingPage.view": "Ikusi",
  "content-manager.containers.SettingViewModel.pluginHeader.title": "Edukien kudeatzailea - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description": "Konfiguratu ezarpen zehatzak",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Bilduma motak",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Konfiguratu zure Bilduma Moten aukera lehenetsiak",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Orokorra",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Konfiguratu zure bilduma mota eta talde guztien ezarpenak",
  "content-manager.containers.SettingsView.list.subtitle": "Konfiguratu zure Bilduma mota eta taldeen maketazioa eta bistaratzea",
  "content-manager.containers.SettingsView.list.title": "Bistaratzeko konfigurazioak",
  "content-manager.edit-settings-view.link-to-ctb.components": "Editatu osagaia",
  "content-manager.edit-settings-view.link-to-ctb.content-types": "Editatu eduki mota",
  "content-manager.emptyAttributes.button": "Joan bilduma motaren eraikitzailera",
  "content-manager.emptyAttributes.description": "Gehitu zure lehen eremua zure Bilduma Motari",
  ...
  "content-manager.error.attribute.taken": "Eremu-izen hau dagoeneko existitzen da",
  "content-manager.error.contentTypeName.taken": "Izen hau dagoeneko existitzen da",
  "content-manager.error.model.fetch": "Errore bat gertatu da ereduen konfigurazioa eskuratzean",
  "content-manager.error.record.create": "Errore bat gertatu da erregistroa sortzean",
  "content-manager.error.record.delete": "Errore bat gertatu da erregistroa ezabatzean",
  "content-manager.error.record.fetch": "Errore bat gertatu da erregistroa eskuratzean",
  "content-manager.error.record.update": "Errore bat gertatu da erregistroa eguneratzean",
  "content-manager.error.records.count": "Errore bat gertatu da zenbaketa-erregistroak eskuratzean",
  "content-manager.error.records.fetch": "Errore bat gertatu da erregistroak eskuratzean",
  "content-manager.error.schema.generation": "Errore bat gertatu da eskema sortzean",
  ...
  "content-manager.error.validation.required": "Balio sarrera hau beharrezkoa da",
  ...
  "content-manager.form.Input.description.placeholder": "Erakutsi izena profilean",
  ...
  "content-manager.form.Input.label.inputDescription": "BBalio honek taularen buruan bistaratzen den etiketa gainidazten du",
  "content-manager.form.Input.pageEntries": "Sarrerak orrialde bakoitzeko",
  "content-manager.form.Input.pageEntries.inputDescription": "Oharra: balio hau baliogabetu dezakezu Bilduma motaren ezarpenen orrian",
  "content-manager.form.Input.placeholder": "Leku-marka",
  "content-manager.form.Input.placeholder.placeholder": "Nire balio ikaragarria",
  ...
  "content-manager.notification.error.displayedFields": "Gutxienez eremu bat erakutsi behar da",
  "content-manager.notification.error.relationship.fetch": "Errore bat gertatu da erlazioa eskuratzean",
  "content-manager.notification.info.SettingPage.disableSort": "Atributu bat izan behar duzu baimenduta dagoen ordenarekin",
  "content-manager.notification.info.minimumFields": "Gutxienez eremu bat erakutsi behar da",
  "content-manager.notification.upload.error": "Errorea gertatu da fitxategiak igotzean",
  "content-manager.pageNotFound": "Orrialdea ez da aurkitu",
  "content-manager.pages.ListView.header-subtitle": "{{number, plural, =0 {# entries} bat {# entry} beste {# entries}} aurkitu dira",
  "content-manager.pages.NoContentType.button": "Sortu zure lehen eduki-mota",
  "content-manager.pages.NoContentType.text": "Oraindik ez duzu edukirik, zure lehen Eduki Mota sortzea gomendatzen dizugu",
  "content-manager.permissions.not-allowed.create": "Ez duzu baimenik dokumentuak sortzeko",
  "content-manager.permissions.not-allowed.update": "Ez duzu dokumentu hau ikusteko baimenik",
  "content-manager.plugin.description.long": "Datu-baseko datuak ikusteko, editatzeko eta ezabatzeko modu azkarra",
  "content-manager.plugin.description.short": "Datu-baseko datuak ikusteko, editatzeko eta ezabatzeko modu azkarra",
  ...
  "content-manager.utils.data-loaded": "{number, plural, =1 {entry has} beste {entries have}} behar bezala kargatu dira",
  "content-manager.apiError.This attribute must be unique": "{field} bakarra izan behar da",
  "content-manager.popUpWarning.warning.has-draft-relations.title": "Berrespena",
  "content-manager.popUpWarning.warning.publish-question": "Oraindik argitaratu nahi duzu?",
  "content-manager.popUpwarning.warning.has-draft-relations.button-confirm": "Bai, argitaratu",
  "content-manager.popUpwarning.warning.has-draft-relations.message": "<b>{count, plural, one { relation is } beste { relations are } }</b> oraindik ez da argitaratu eta baliteke ustekabeko portaera izatea",
