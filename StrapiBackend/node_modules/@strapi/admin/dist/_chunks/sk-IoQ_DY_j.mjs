...
const sk = {
  ...
  "content-manager.ListViewTable.relation-loaded": "Prepojenia boli úspešne načítané",
  "content-manager.ListViewTable.relation-loading": "Prepojenia sa načítavajú",
  "content-manager.ListViewTable.relation-more": "Toto prepojenie obsahuje viac záznamov, ako je zobrazených",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Nastaviť podmienky pre filtrovanie záznamov",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Upravte vzhľad zobrazenia úprav.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Zvoľte nastavenia zobrazenia zoznamu.",
  ...
  "content-manager.containers.SettingPage.attributes.description": "Nastavte poradie atribútov",
  ...
  "content-manager.containers.SettingPage.listSettings.title": "Zobrazenie zoznamu (nastavenia)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Konfigurovať špecifické nastavenia pre tento typ kolekcie",
  ...
  "content-manager.error.model.fetch": "Nastala chyba pri načitávaní nastavení modelov.",
  "content-manager.error.record.create": "Nastala chyba pri vytváraní záznamu.",
  "content-manager.error.record.delete": "Nastala chyba pri vymazávaní záznamu.",
  "content-manager.error.record.fetch": "Nastala chyba pri načitávaní záznamu.",
  "content-manager.error.record.update": "Nastala chyba pri upravovaní záznamu.",
  "content-manager.error.records.count": "Nastala chyba pri načitávaní počtu záznamov.",
  "content-manager.error.records.fetch": "Nastala chyba pri načitávaní záznamov.",
  "content-manager.error.schema.generation": "Nastala chyba pri vytváraní návrhu.",
  ...
  "content-manager.error.validation.minLength": "Táto hodnota je príliš krátka.",
  "content-manager.error.validation.minSupMax": "Nemôže byť nadriadený",
  "content-manager.error.validation.regex": "Táto hodnota nespĺňa požadovaný vzor",
  ...
  "content-manager.form.Input.description.placeholder": "Zobraziť meno v profile",
  ...
  "content-manager.form.Input.label.inputDescription": "Táto hodnota prepisuje popis zobrazený v hlavičke tabuľky",
  "content-manager.form.Input.pageEntries": "Záznamy na stránku",
  "content-manager.form.Input.pageEntries.inputDescription": "Poznámka: Túto hodnotu môžete prepísať na stránke nastavení typu kolekcie.",
