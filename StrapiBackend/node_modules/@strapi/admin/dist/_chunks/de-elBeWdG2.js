...
const de = {
  ...
  "content-manager.components.DynamicZone.error-message": "Die Komponente enthält einen oder mehrere Fehler",
  "content-manager.components.DynamicZone.missing-components": "{number, plura, one {# Komponente} other {# Komponenten}} fehlen",
  "content-manager.components.DynamicZone.move-down-label": "Verschiebe Komponente nach unten",
  "content-manager.components.DynamicZone.move-up-label": "Verschiebe Komponente nach oben",
  ...
  "content-manager.components.EmptyAttributesBlock.button": "Gehe zu den Einstellungen",
  "content-manager.components.EmptyAttributesBlock.description": "Du kannst deine Einstellungen ändern",
  "content-manager.components.FieldItem.linkToComponentLayout": "Layout der Komponente anpassen",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "Anwenden",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Alle löschen",
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Lege die Bedingungen fest, unter denen die Einträge gefiltert werden sollen",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter": "Filter",
  "content-manager.components.FiltersPickWrapper.hide": "Ausblenden",
  "content-manager.components.LeftMenu.Search.label": "Suche nach einem Inhaltstyp",
  ...
  "content-manager.components.NotAllowedInput.text": "Keine Berechtigung dieses Feld anzusehen",
  "content-manager.components.RepeatableComponent.error-message": "Die Komponente(n) enthält einen/enthalten Fehler",
  "content-manager.components.Search.placeholder": "Suche nach einem Eintrag....",
  "content-manager.components.Select.draft-info-title": "Status: Entwurf",
  "content-manager.components.Select.publish-info-title": "State: Veröffentlicht",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Anpassen, wie die Bearbeitungsansicht aussieht.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Einstellungen der Listenansicht anpassen.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "Ansicht anpassen - {name}",
  "content-manager.components.TableDelete.delete": "Alle löschen",
  "content-manager.components.TableDelete.deleteSelected": "Ausgewählte löschen",
  "content-manager.components.TableDelete.label": "{number, plural, one {# Eintrag} other {# Einträge}} ausgewählt",
  "content-manager.components.TableEmpty.withFilters": "Es gibt keine {contentType} mit den verwendeten Filtern...",
  "content-manager.components.TableEmpty.withSearch": "Es gibt keine {contentType}, die der Suche ({search}) entsprechen...",
  "content-manager.components.TableEmpty.withoutFilter": "Es gibt keine {contentType}...",
  "content-manager.components.empty-repeatable": "Noch keine Einträge. Nutze den Button unten um einen hinzuzufügen.",
  "content-manager.components.notification.info.maximum-requirement": "Die maximale Anzahl an Feldern wurde erreicht",
  "content-manager.components.notification.info.minimum-requirement": "Es wurde ein Feld hinzugefügt um die minimale Anzahl zu erfüllen",
  "content-manager.components.repeatable.reorder.error": "Während dem Ändern der Reihenfolge der Komponenten ist ein Fehler aufgetreten, bitte versuche es erneut",
  ...
  "content-manager.containers.Edit.clickToJump": "Klicke, um zu einem Eintrag zu springen",
  ...
  "content-manager.containers.Edit.information.publishedVersion": "veröffentlichte Version",
  ...
  "content-manager.containers.SettingPage.attributes.description": "Reihenfolge der Attribute festlegen",
  "content-manager.containers.SettingPage.editSettings.description": "Ziehe die Felder via Drag & Drop, um das Layout zu erstellen",
  "content-manager.containers.SettingPage.editSettings.entry.title": "Anzeigefeld",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Anzeigefeld der Einträge wählen",
  "content-manager.containers.SettingPage.editSettings.relation-field.description": "Setze das dargestellte Feld sowohl in der Bearbeiten-, als auch der Listenansicht",
  "content-manager.containers.SettingPage.editSettings.title": "Bearbeiten (einstellungen)",
  "content-manager.containers.SettingPage.layout": "Layout",
  "content-manager.containers.SettingPage.listSettings.description": "Konfiguriere die Einstellungen für diesen Collection Type",
  "content-manager.containers.SettingPage.listSettings.title": "Listenansicht (Einstellungen)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Konfiguriere die spezifische Ansicht für diesen Collection Type",
  "content-manager.containers.SettingPage.settings": "Einstellungen",
  "content-manager.containers.SettingPage.view": "Ansicht",
  "content-manager.containers.SettingViewModel.pluginHeader.title": "Inhalts-Manager - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description": "Spezifische Einstellungen konfigurieren",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Sammlungen",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Standardoptionen für Sammlungen konfigurieren",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Generell",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Einstellungen für alle Sammlungen und Gruppen konfigurieren",
  "content-manager.containers.SettingsView.list.subtitle": "Layout und Darstellung für alle Sammlungen und Gruppen konfigurieren",
  "content-manager.containers.SettingsView.list.title": "Darstellungsoptionen",
  "content-manager.edit-settings-view.link-to-ctb.components": "Komponente bearbeiten",
  "content-manager.edit-settings-view.link-to-ctb.content-types": "Inhalts-Typ bearbeiten",
  "content-manager.emptyAttributes.button": "Zum Sammlungs-Editor",
  "content-manager.emptyAttributes.description": "Füge das erste Feld zur Sammlung hinzu",
  ...
  "content-manager.error.attribute.taken": "Dieser Feldname ist bereits vergeben",
  "content-manager.error.contentTypeName.taken": "Dieser Name existiert bereits",
  "content-manager.error.model.fetch": "Beim Abruf von model config fetch ist ein Fehler aufgetreten.",
  "content-manager.error.record.create": "Beim Anlegen eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.delete": "Beim Löschen eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.fetch": "Beim Abruf eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.update": "Beim Aktualisieren eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.records.count": "Beim Abrufen der Anzahl an Einträgen ist ein Fehler aufgetreten.",
  "content-manager.error.records.fetch": "Beim Abrufen von Dokumenten ist ein Fehler aufgetreten.",
  "content-manager.error.schema.generation": "Bei der Generierung des Schemas ist ein Fehler aufgetreten.",
  ...
  "content-manager.error.validation.regex": "Dieser Wert entspricht nicht dem RegEx.",
  ...
  "content-manager.form.Input.description.placeholder": "Zeige den Namen im Profil",
  ...
  "content-manager.form.Input.label.inputDescription": "Dieser Wert überschreibt das im Kopf der Tabelle angezeigte Label.",
  "content-manager.form.Input.pageEntries": "Einträge pro Seite",
  "content-manager.form.Input.pageEntries.inputDescription": "Hinweis: Dieser Wert lässt sich durch die Sammlungs-Einstellungen überschreiben.",
  "content-manager.form.Input.placeholder": "Platzhalter",
  "content-manager.form.Input.placeholder.placeholder": "Mein unglaublicher Wert",
  ...
  "content-manager.form.Input.sort.field": "Sortierung in diesem Feld aktivieren",
  ...
  "content-manager.notification.error.displayedFields": "Du benötigst mindestens ein dargestelltes Feld",
  "content-manager.notification.error.relationship.fetch": "Beim Abruf von Beziehungen ist ein Fehler aufgetreten.",
  "content-manager.notification.info.SettingPage.disableSort": "Du musst ein Attribut mit aktivierter Sortierung haben.",
  "content-manager.notification.info.minimumFields": "Du benötigst mindestens ein dargestelltes Feld",
  "content-manager.notification.upload.error": "Beim Hochladen deiner Dateien ist ein Fehler aufgetreten",
  "content-manager.pageNotFound": "Seite nicht gefunden",
  "content-manager.pages.ListView.header-subtitle": "{number, plural, one {# Eintrag} other {# Einträge}} gefunden",
  "content-manager.pages.NoContentType.button": "Erstelle deinen ersten Inhalts-Typ",
  "content-manager.pages.NoContentType.text": "Wenn du noch keinen Inhalt hast, empfehlen wir dir, zuerst einen Inhalts-Typ erstellen.",
  "content-manager.permissions.not-allowed.create": "Du hast nicht die erforderlichen Berechtigungen, um ein Dokument zu erstellen",
  "content-manager.permissions.not-allowed.update": "Du hast nicht die erforderlichen Berechtigungen, um dieses Dokument anzuschauen",
  "content-manager.plugin.description.long": "Greife schnell auf alle Daten in der Datenbank zu und ändere sie.",
  "content-manager.plugin.description.short": "Greife schnell auf alle Daten in der Datenbank zu und ändere sie.",
