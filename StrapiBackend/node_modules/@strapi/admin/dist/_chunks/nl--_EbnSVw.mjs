...
const nl = {
  ...
  "content-manager.ListViewTable.relation-more": "Deze relatie bevat meer entiteiten dan weergegeven",
  ...
  "content-manager.components.DynamicZone.ComponentPicker-label": "Kies één component",
  "content-manager.components.DynamicZone.add-component": "Voeg een component toe aan {componentName}",
  "content-manager.components.DynamicZone.delete-label": "Verwijder {name}",
  "content-manager.components.DynamicZone.error-message": "Het component bevat fout(en)",
  "content-manager.components.DynamicZone.missing-components": "Er {number, plural, =0 {zijn # missende componenten} one {is één # missend component} other {zijn # missende componenten}}",
  "content-manager.components.DynamicZone.move-down-label": "Verplaats component naar beneden",
  "content-manager.components.DynamicZone.move-up-label": "Verplaats component naar boven",
  ...
  "content-manager.components.EmptyAttributesBlock.button": "Ga naar instellingspagina",
  "content-manager.components.EmptyAttributesBlock.description": "Je kunt je instellingen wijzigen",
  "content-manager.components.FieldItem.linkToComponentLayout": "Stel de lay-out van het component in",
  "content-manager.components.FieldSelect.label": "Voeg veld toe",
  "content-manager.components.FilterOptions.button.apply": "Pas toe",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "Pas toe",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Wis alles",
  ...
  "content-manager.components.NotAllowedInput.text": "Geen rechten om dit veld te bekijken",
  "content-manager.components.RepeatableComponent.error-message": "Eén of meerdere componenten bevatten een fout",
  ...
  "content-manager.components.Select.publish-info-title": "Status: Gepubliceerd",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Pas aan hoe de bewerkingsweergave eruit zal zien.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Definieer de instellingen van de lijstweergave.",
  ...
  "content-manager.components.empty-repeatable": "Nog geen items. Klik op de knop hieronder om er een toe te voegen.",
  "content-manager.components.notification.info.maximum-requirement": "Je hebt het maximale aantal velden al bereikt",
  "content-manager.components.notification.info.minimum-requirement": "Een veld is toegevoegd om te voldoen aan de minimale voorwaarde",
  "content-manager.components.repeatable.reorder.error": "Er is een fout opgetreden bij het opnieuw sorteren van het veld van je component, probeer het a.u.b. opnieuw",
  ...
  "content-manager.containers.Edit.clickToJump": "Klik om naar de invoer te springen",
  ...
  "content-manager.containers.Edit.information.publishedVersion": "gepubliceerde versie",
  "content-manager.containers.Edit.pluginHeader.title.new": "Voeg een invoer toe",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field": "Veld aanpassen",
  "content-manager.containers.EditView.add.new-entry": "Voeg een invoer toe",
  "content-manager.containers.EditView.notification.errors": "Het formulier bevat fouten",
  "content-manager.containers.Home.introduction": "Om items aan te passen klik je op de link in het menu links boven. Deze plugin heeft nog geen goede manier om instellingen aan te passen en is nog in ontwikkeling.",
  "content-manager.containers.Home.pluginHeaderDescription": "Onderhoud je data via een krachtig en mooie interface.",
  ...
  "content-manager.containers.SettingPage.attributes.description": "Geef de volgorde van de attributen aan",
  "content-manager.containers.SettingPage.editSettings.description": "Klik & sleep de velden om de lay-out te bouwen",
  "content-manager.containers.SettingPage.editSettings.entry.title": "Invoer titel",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Stel het weergegeven veld van je invoer in",
  "content-manager.containers.SettingPage.editSettings.relation-field.description": "Stel het weergegeven veld in voor zowel de bewerkings- als de lijstweergave",
  "content-manager.containers.SettingPage.editSettings.title": "Weergave aanpassen (instellingen)",
  "content-manager.containers.SettingPage.layout": "Lay-out",
  "content-manager.containers.SettingPage.listSettings.description": "Configureer de opties voor dit collectie type",
  "content-manager.containers.SettingPage.listSettings.title": "Lijstweergave (instellingen)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Configureer de specifieke instellingen voor dit collectie type",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description": "Configureer de specifieke instellingen",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Collectie Types",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Configureer de standaard instellingen voor je Collection Types",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Algemeen",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Configureer de instellingen voor je collectie types en groepen",
  ...
  "content-manager.error.model.fetch": "Er is een fout opgetreden tijdens het ophalen van de modellen.",
  "content-manager.error.record.create": "Er is een fout opgetreden tijdens het maken van het item.",
  "content-manager.error.record.delete": "Er is een fout opgetreden tijdens het verwijderen van het item.",
  "content-manager.error.record.fetch": "Er is een fout opgetreden tijdens het ophalen van het item.",
  "content-manager.error.record.update": "Er is een fout opgetreden tijdens het opslaan van het item.",
  "content-manager.error.records.count": "Er is een fout opgetreden tijdens het tellen van de opgehaalde gegevens.",
  "content-manager.error.records.fetch": "Er is een fout opgetreden tijdens het ophalen van de gegevens.",
  "content-manager.error.schema.generation": "Er is een fout opgetreden tijdens het maken van het schema.",
  ...
  "content-manager.error.validation.regex": "De waarde is niet gelijk aan de regex.",
  ...
  "content-manager.form.Input.description.placeholder": "Weergavenaam in het profiel",
  ...
  "content-manager.notification.error.displayedFields": "Je hebt op z'n minst één weergegeven veld nodig.",
  "content-manager.notification.error.relationship.fetch": "Er is een fout opgetreden tijdens het ophalen van de relaties.",
  "content-manager.notification.info.SettingPage.disableSort": "Je hebt op z'n minst één attribuut nodig waar sorteren toegestaan is.",
