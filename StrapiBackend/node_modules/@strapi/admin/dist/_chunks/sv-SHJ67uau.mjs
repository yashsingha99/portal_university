...
const sv = {
  ...
  "content-manager.ListViewTable.relation-more": "Denna relation innehåller mer data än vad som visas",
  ...
  "content-manager.components.DynamicZone.ComponentPicker-label": "Välj en komponent",
  "content-manager.components.DynamicZone.add-component": "Lägg till en komponent till {componentName}",
  "content-manager.components.DynamicZone.delete-label": "Ta bort {name}",
  "content-manager.components.DynamicZone.error-message": "Komponenten innehåller fel",
  "content-manager.components.DynamicZone.missing-components": "Det {number, plural, =0 {# saknas komponenter} one {# saknas en komponent} other {are # saknas komponenter}}",
  "content-manager.components.DynamicZone.move-down-label": "Flytta ned komponenten",
  "content-manager.components.DynamicZone.move-up-label": "Flytta upp komponenten",
  ...
  "content-manager.components.EmptyAttributesBlock.button": "Gå till inställningssidan",
  "content-manager.components.EmptyAttributesBlock.description": "Du kan ändra dina inställningar",
  "content-manager.components.FieldItem.linkToComponentLayout": "Ställ in komponentens layout",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "Verkställ",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Rensa alla",
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Ställ in de villkor som ska gälla för att filtrera posterna",
  ...
  "content-manager.components.LeftMenu.Search.label": "Sök efter en innehållstyp",
  ...
  "content-manager.components.NotAllowedInput.text": "Ingen behörighet att se detta fält",
  "content-manager.components.RepeatableComponent.error-message": "Komponenten/komponenterna innehåller fel",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Anpassa hur redigeringsvyn kommer att se ut.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Definiera inställningarna för listvyn.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "Konfigurera vyn - {name}",
  ...
  "content-manager.components.TableDelete.label": "{number, plural, one {# post} other {# poster}} valda",
  "content-manager.components.TableEmpty.withFilters": "Det finns inga {contentType} med de valda filtren...",
  "content-manager.components.TableEmpty.withSearch": "Det finns inga {contentType} som motsvarar sökningen ({search})...",
  "content-manager.components.TableEmpty.withoutFilter": "Det finns inga {contentType}...",
  "content-manager.components.empty-repeatable": "Inga poster än. Klicka på knappen nedan för att lägga till en.",
  "content-manager.components.notification.info.maximum-requirement": "Du har redan nått det maximala antalet fält",
  "content-manager.components.notification.info.minimum-requirement": "Ett fält har lagts till för att matcha minimikravet",
  "content-manager.components.repeatable.reorder.error": "Ett fel uppstod när du ändrade ordningen på komponentens fält, försök igen",
  ...
  "content-manager.containers.Edit.clickToJump": "Klicka för att gå till posten",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field": "Redigera fältet",
  "content-manager.containers.EditView.add.new-entry": "Lägg till en post",
  "content-manager.containers.EditView.notification.errors": "Formuläret innehåller några fel",
  "content-manager.containers.Home.introduction": "För att redigera dina poster gå till postens länk i vänstermenyn. Detta plugin har inte ett fungerande sätt att redigera inställningar och är fortfarande under aktiv utveckling.",
  "content-manager.containers.Home.pluginHeaderDescription": "Hantera poster genom ett kraftfullt och vackert gränssnitt.",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title": "Posttitel",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Ställ in det uppvisade fältet för din post",
  "content-manager.containers.SettingPage.editSettings.relation-field.description": "Ställ in det uppvisade fältet i både redigerings- och listvyn",
  "content-manager.containers.SettingPage.editSettings.title": "Redigera vy (inställningar)",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description": "Konfigurera de specificerade inställningarna",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Samlingstyper",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Konfigurera standardalternativen för dina samlingstyper",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Allmänt",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Konfigurera inställningarna för alla dina samlingstyper och grupper",
  "content-manager.containers.SettingsView.list.subtitle": "Konfigurera layouten och visningen av dina samlingstyper och grupper",
  ...
  "content-manager.error.model.fetch": "Ett fel inträffade under hämtning av modellkonfigurationen.",
  "content-manager.error.record.create": "Ett fel uppstod under skapandet av posten.",
  "content-manager.error.record.delete": "Ett fel uppstod under raderingen av posten.",
  ...
  "content-manager.error.records.count": "Ett fel uppstod under räkning av posthämtningen",
  "content-manager.error.records.fetch": "Ett fel uppstod under hämtning av poster.",
  "content-manager.error.schema.generation": "Ett fel uppstod under schemagenerering.",
  ...
  "content-manager.form.Input.label.inputDescription": "Detta värde överskrider etiketten som visas i tabellhuvudet",
  "content-manager.form.Input.pageEntries": "Poster per sida",
  "content-manager.form.Input.pageEntries.inputDescription": "Obs! Du kan överskrida det här värdet på inställningssidan för samlingstypen.",
  "content-manager.form.Input.placeholder": "Placeholder",
  "content-manager.form.Input.placeholder.placeholder": "Mitt fantastiska värde",
  "content-manager.form.Input.search": "Aktivera sökning",
  "content-manager.form.Input.search.field": "Aktivera sökning av det här fältet",
  "content-manager.form.Input.sort.field": "Aktivera sortering av det här fältet",
  ...
  "content-manager.notification.error.displayedFields": "Du behöver minst ett fält som visas upp",
  "content-manager.notification.error.relationship.fetch": "Ett fel uppstod under relationshämtning.",
  "content-manager.notification.info.SettingPage.disableSort": "Du måste ha ett attribut med sortering tillåtet",
  "content-manager.notification.info.minimumFields": "Du måste ha minst ett fält uppvisat",
  "content-manager.notification.upload.error": "Ett fel uppstod när dina filer laddades upp",
  "content-manager.pageNotFound": "Sidan hittas inte",
  "content-manager.pages.ListView.header-subtitle": "{number, plural, =0 {# poster} one {# post} other {# poster}} hittade",
  "content-manager.pages.NoContentType.button": "Skapa din första innehållstyp",
  "content-manager.pages.NoContentType.text": "Du har inget innehåll än, vi föreslår att du skapar din första innehållstyp.",
  "content-manager.permissions.not-allowed.create": "Du får inte skapa ett dokument",
  "content-manager.permissions.not-allowed.update": "Du får inte se detta dokument",
  "content-manager.plugin.description.long": "Snabbt sätt att se, redigera och ta bort data i din databas.",
  "content-manager.plugin.description.short": "Snabbt sätt att se, redigera och ta bort data i din databas.",
