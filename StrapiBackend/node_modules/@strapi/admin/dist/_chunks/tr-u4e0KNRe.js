...
const tr = {
  ...
  "content-manager.ListViewTable.relation-more": "Bu ilişki gösterilenden daha çok kayıt içeriyor",
  "content-manager.EditRelations.title": "İlişkili Data",
  "content-manager.HeaderLayout.button.label-add-entry": "Yeni bir girdi oluştur",
  "content-manager.api.id": "API KİMLİK NO",
  "content-manager.apiError.This attribute must be unique": "{field} benzersiz olmalı",
  ...
  "content-manager.components.DynamicZone.add-component": "{componentName}'e bir bileşen ekle",
  "content-manager.components.DynamicZone.delete-label": "Sil: {name}",
  "content-manager.components.DynamicZone.error-message": "Bileşen bir ya da daha fazla hata içeriyor",
  "content-manager.components.DynamicZone.missing-components": "{number} eksik bileşen var",
  ...
  "content-manager.components.FieldItem.linkToComponentLayout": "Bileşenin düzenini belirle",
  ...
  "content-manager.components.NotAllowedInput.text": "Bu alanı görmek için iznin yok",
  "content-manager.components.RepeatableComponent.error-message": "Bileşen ya da bileşenler bir ya da daha çok hata içeriyor",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Düzenleme görünümünü özelleştir",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Liste görünümünün ayarlarını belirle.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "Görünümü ayarla - {name}",
  ...
  "content-manager.components.empty-repeatable": "Henüz bir girdi yok. Aşağıdaki butona bas ve ekle.",
  "content-manager.components.notification.info.maximum-requirement": "Alan sayı sınırına ulaştınız.",
  "content-manager.components.notification.info.minimum-requirement": "Minimum gerekleri sağlayacak bir alan eklendi",
  "content-manager.components.repeatable.reorder.error": "Bileşenin alanlarının sırasını değiştirirken bir hata oluştu. Lütfen tekrar deneyin.",
  ...
  "content-manager.containers.Edit.information.draftVersion": "taslak versiyonu",
  ...
  "content-manager.containers.Edit.information.publishedVersion": "yayınlanan versiyonu",
  ...
  "content-manager.containers.ListSettingsView.modal-form.edit-label": "Düzenle: {fieldName}",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Girdinin görüntülenen alanını belirle",
  "content-manager.containers.SettingPage.editSettings.relation-field.description": "Düzenleme ve listeleme görünümünde görüntülenecek alanı belirle",
  ...
  "content-manager.containers.SettingPage.listSettings.description": "Bu koleksiyon tipi için seçenekleri düzenle",
  "content-manager.containers.SettingPage.listSettings.title": "Liste (ayarlar)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Bu koleksiyon tipi için özel ayarlı düzenle",
  "content-manager.containers.SettingPage.settings": "Ayarlar",
  "content-manager.containers.SettingPage.view": "Görüntüle",
  "content-manager.containers.SettingViewModel.pluginHeader.title": "İçerik Yöneticisi - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description": "Belirli ayarları yapılandırın",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Koleksiyon Tipleri",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Koleksiyon tiplerin için varsayılan seçenekleri düzenle",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Genel",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Tüm Koleksiyon Tiplerin ve Gruplarının ayarlarını düzenle",
  "content-manager.containers.SettingsView.list.subtitle": "Koleksiyon ve Gruplarının düzen ve görünümlerini düzenle",
  "content-manager.containers.SettingsView.list.title": "Düzenlemelerini görüntüle",
  ...
  "content-manager.emptyAttributes.description": "Koleksiyon Tipine ilk alanı ekle",
  ...
  "content-manager.notification.info.minimumFields": "En az bir alan görüntülenebilir olmalı",
  "content-manager.notification.upload.error": "Dosyalarını yüklerken bir hata oluştu",
  ...
  "content-manager.pages.NoContentType.text": "Henüz hiç içeriğin yok. Bir İçerik Tipi oluşturarak işe başlamanı öneririz.",
  "content-manager.permissions.not-allowed.create": "Belge oluşturma iznin yok",
  "content-manager.permissions.not-allowed.update": "Bu belgeyi görme iznin yok",
  ...
  "content-manager.popUpWarning.warning.publish-question": "Hala yayınlamak istiyor musun?",
  "content-manager.popUpwarning.warning.has-draft-relations.button-confirm": "Evet, yayınla",
  "content-manager.popUpwarning.warning.has-draft-relations.message": "<b>{count} ilişki henüz yayınlanmadı ve bu beklenmedik bir davranışa yol açabilir.",
