...
const ms = {
  ...
  "content-manager.components.EmptyAttributesBlock.button": "Pergi ke halaman tetapan",
  "content-manager.components.EmptyAttributesBlock.description": "Anda boleh ubah tetapan anda",
  "content-manager.components.FieldItem.linkToComponentLayout": "Tetapkan susun atur komponen",
  "content-manager.components.FilterOptions.button.apply": "Gunakan",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.apply": "Gunakan",
  "content-manager.components.FiltersPickWrapper.PluginHeader.actions.clearAll": "Kosongkan semua",
  "content-manager.components.FiltersPickWrapper.PluginHeader.description": "Tetapkan syarat yang akan digunakan untuk tapis entri",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter": "Tapisan",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings": "Ubah paparan untuk pengeditan.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings": "Tentukan tetapan paparan senarai.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title": "Konfigurasikan paparan - {name}",
  ...
  "content-manager.components.TableEmpty.withFilters": "Tiada {contentType} dalam tapisan...",
  "content-manager.components.TableEmpty.withSearch": "Tiada {contentType} yang sesuai dengan carian ({search})...",
  "content-manager.components.TableEmpty.withoutFilter": "Tiada {contentType}...",
  "content-manager.components.empty-repeatable": "Belum ada entri. Klik pada butang di bawah untuk tambah satu",
  "content-manager.components.notification.info.maximum-requirement": "Anda sudah mencapai bilangan ruang maksimum",
  "content-manager.components.notification.info.minimum-requirement": "Ruang telah ditambahkan untuk memenuhi syarat minimum",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field": "Edit ruang",
  "content-manager.containers.EditView.notification.errors": "Borang mengandungi beberapa kesalahan",
  "content-manager.containers.Home.introduction": "Untuk mengedit entri anda, pergi ke pautan yang ditetapkan di menu sebelah kiri. Plugin ini tidak mempunyai cara yang betul untuk mengedit tetapan dan masih dalam pembangunan yang aktif",
  "content-manager.containers.Home.pluginHeaderDescription": "Uruskan entri anda melalui antaramuka yang hebat dan cantik.",
  ...
  "content-manager.containers.ListPage.displayedFields": "Ruang yang dipamirkan",
  ...
  "content-manager.containers.SettingPage.attributes.description": "Tentukan tertib untuk ciri-ciri",
  "content-manager.containers.SettingPage.editSettings.description": "Tarik & Lepas ruang untuk menyusun atur",
  "content-manager.containers.SettingPage.editSettings.entry.title": "Pilihan nama entri",
  "content-manager.containers.SettingPage.editSettings.entry.title.description": "Pilih ruang yang akan dipaparkan sebagai nama untuk entri anda.",
  "content-manager.containers.SettingPage.editSettings.title": "Edit paparan (tetapan)",
  "content-manager.containers.SettingPage.layout": "Susun atur",
  "content-manager.containers.SettingPage.listSettings.description": "Tetapkan pilihan yang ada untuk jenis koleksi ini",
  "content-manager.containers.SettingPage.listSettings.title": "Paparan senarai (tetapan)",
  "content-manager.containers.SettingPage.pluginHeaderDescription": "Tetapkan tetapan khusus untuk Jenis Koleksi ini",
  "content-manager.containers.SettingPage.settings": "Tetapan",
  "content-manager.containers.SettingPage.view": "Sususnan",
  "content-manager.containers.SettingViewModel.pluginHeader.title": "Pengurus Kandungan - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description": "Tetapkan tetapan tertentu",
  "content-manager.containers.SettingsPage.Block.contentType.title": "Jenis Koleksi(Collection Types)",
  "content-manager.containers.SettingsPage.Block.generalSettings.description": "Tetapkan pilihan lalai untuk Jenis Koleksi anda",
  "content-manager.containers.SettingsPage.Block.generalSettings.title": "Am(General)",
  "content-manager.containers.SettingsPage.pluginHeaderDescription": "Tetapkan tetapan untuk semua Jenis koleksi dan Kumpulan anda",
  "content-manager.containers.SettingsView.list.subtitle": "Tetapkan susun atur dan paparan Jenis koleksi dan kumpulan anda",
  ...
  "content-manager.emptyAttributes.description": "Tambah ruang pertama anda ke Jenis Koleksi anda",
  ...
  "content-manager.error.model.fetch": "Ralat berlaku sewaktu mendapatkan tetapan model ",
  "content-manager.error.record.create": "Ralat berlaku sewaktu membuat rekod.",
  "content-manager.error.record.delete": "Ralat berlaku sewaktu penghapusan rekod.",
  "content-manager.error.record.fetch": "Ralat berlaku sewaktu mendapatkan rekod.",
  "content-manager.error.record.update": "Ralat berlaku sewaktu mengemaskini rekod.",
  "content-manager.error.records.count": "Ralat berlaku sewaktu mendapatkan kiraan rekod.",
  "content-manager.error.records.fetch": "Ralat berlaku sewaktu mendapatkan rekod.",
  "content-manager.error.schema.generation": "Ralat berlaku sewaktu penghasilan skema.",
  ...
  "content-manager.error.validation.maxLength": "Panjang isinya terlalu panjang.",
  "content-manager.error.validation.min": "Nilai isinya terlalu rendah.",
  "content-manager.error.validation.minLength": "Panjang isinya terlalu pendek.",
  "content-manager.error.validation.minSupMax": "Tidak boleh lebih tinggi",
  "content-manager.error.validation.regex": "Nilai isinya tidak sepadan dengan regex.",
  ...
  "content-manager.form.Input.description.placeholder": "Paparkan nama dalam profil",
  ...
  "content-manager.form.Input.label.inputDescription": "Isinya ini menggantikan label yang dipaparkan di tajuk jadual",
  "content-manager.form.Input.pageEntries": "Entri setiap halaman",
  "content-manager.form.Input.pageEntries.inputDescription": "Catatan: Anda boleh menukarkan nilai ini di halaman tetapan Jenis Koleksi",
  ...
  "content-manager.notification.error.displayedFields": "Anda perlukan sekurang-kurangnya satu ruang yang dipaparkan",
  "content-manager.notification.error.relationship.fetch": "Ralat berlaku sewaktu mendapatkan perhubungan data.",
  "content-manager.notification.info.SettingPage.disableSort": "Anda mesti mempunyai satu attribute dengan penertib yang telah dibenarkan(You need to have one attribute with the sorting allowed)",
  "content-manager.notification.info.minimumFields": "Anda mesti memaparkan sekurang-kurangnya satu ruang",
  "content-manager.notification.upload.error": "Berlaku ralat sewaktu memuat naik fail anda",
  "content-manager.pageNotFound": "Laman tidak dijumpai",
  "content-manager.plugin.description.long": "Cara cepat untuk melihat, mengedit dan menghapus data dalam pangkalan data anda.",
  "content-manager.plugin.description.short": "Cara cepat untuk melihat, mengedit dan menghapus data dalam pangkalan data anda.",
  "content-manager.popUpWarning.bodyMessage.contentType.delete": "Adakah anda pasti mahu memadam entri ini?",
  "content-manager.popUpWarning.bodyMessage.contentType.delete.all": "Adakah anda pasti mahu memadam entri ini?",
  "content-manager.popUpWarning.warning.cancelAllSettings": "Adakah anda pasti mahu membatalkan pengubahsuaian anda?",
  "content-manager.popUpWarning.warning.updateAllSettings": "Ini akan mengubah semua tetapan anda",
