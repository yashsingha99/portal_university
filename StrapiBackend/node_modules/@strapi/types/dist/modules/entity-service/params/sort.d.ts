...
export type ObjectNotation<TSchemaUID extends Common.UID.Schema> = {
    [TKey in ObjectNotationKeys<TSchemaUID>]?: TKey extends SingleAttribute<TSchemaUID> ? OrderKind.Any : TKey extends Attribute.GetKeysWithTarget<TSchemaUID> ? ObjectNotation<Attribute.GetTarget<TSchemaUID, TKey>> : never;
};
/**
 ...
 */
type ObjectNotationKeys<TSchemaUID extends Common.UID.Schema> = SingleAttribute<TSchemaUID> | Attribute.GetKeysWithTarget<TSchemaUID>;
/**
